...
int main(){
	CPS::SocketFd communication_fd = CPS::SocketLibraryManager::manager().socket(CPS::AddressFamily::ipv6,CPS::SocketType::Datagram,CPS::SocketProtocol::UDP);
	CPS::SocketAddress local_addr = CPS::SocketAddress::loopBackAddress(1234,CPS::AddressFamily::ipv6);
	// 服务器需要绑定本地地址
