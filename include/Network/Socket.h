...
namespace AntonaStandard::Network{
    ...
    public:
        ...
        virtual IPType getIPType()=0;
        virtual ~SocketAddressImp()=default;
        virtual std::shared_ptr<SocketAddressImp> copy()=0;
    };
    ...
    public:
        ...
        virtual IPType getIPType()override;
    ...
    public: 
        SocketAddress(IPType ip_type,unsigned short port,std::string ip);
        ...
        inline IPType getIPType()const{
            return this->imp->getIPType();
        }
    ...
    public:
        ...
        static SocketAddress loopBackAddress(unsigned short port,IPType ip_type=IPType::ipv4);
    ...
    protected:
        ...
        virtual void listen();
        virtual SocketAddress accept(SocketFD& remote_fd);
        size_t receive(SocketFD remote_fd,SocketDataBuffer& buffer);
        size_t send(SocketFD remote_fd,const SocketDataBuffer& buffer);
