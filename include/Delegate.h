...
*   2023/1/1    1.1.0 - 参考了包装器是他的::function的模板写法，解决了原来Delegate<void,void>增加无返回值无参数类型（void(void)）型以及其它无参数类型函数报错的问题，现在正确的写法是Delegate<void()>或Delegate<void(void)>
