...
int main(){
	CPS::SocketFd communication_fd = CPS::SocketLibraryManager::manager().socket(CPS::AddressFamily::ipv6, CPS::SocketType::Stream, CPS::SocketProtocol::TCP);
	CPS::SocketAddress remote_addr(CPS::AddressFamily::ipv6, "::1", 8080);
